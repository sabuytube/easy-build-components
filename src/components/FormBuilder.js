        ...
        const formatFormFields = fields => {
            return fields.map(field => {
                let formField = {
                    ...
                    rules: (
                        field.rules || [
                            { required: true, message: `Please input ${field.title || field.label}!` },
                        ]
                    ).map(r => {
...
export default function ${componentName}() {
    ...
    const options = {
            ...
            form: {
                ...
                fields: ${JSON.stringify(formatFormFields(formFields), null, 8).replace(
            /"__REGEXP_([^_]+)__"/g,
                                ...
                                <Card>
                                    ...
                                    >
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>
                                                downloadCode(generatePageCode(), `${sanitizedTableName}.page.js`)
                                            }
                                        >
                                            Download
                                        </Button>
                                ...
                                <Card>
                                    ...
                                    >
                                        ...
                                        <Button
                                            icon={<DownloadOutlined />}
                                            onClick={() =>
                                                downloadCode(generateSqlCode(), `${sanitizedTableName}.sql`)
                                            }
                                        >
                                            Download
                                        </Button>
...
const FormBuilder = () => {
    ...
    const computeCrudOptions = () => {
        ...
        const { cardGroupSetting, globalFilters, paginationSettings, ...otherSettings } =
        formSettings || {};
        ...
        return {
            ...
            form: {
                settings: {
                    ...
                    addModalTitle:
                        otherSettings?.modalTitle || `Add New ${otherSettings?.title || 'Record'}`,
        ...
        try {
            ...
            if (values.required) {
                fieldToSave.rules.push({
                    required: true,
                    message:
                        values.requiredMessage?.trim() || `Please input ${values.title.trim()}!`,
                });
            }
                    ...
                    {fieldTypes.map(type => (
                        <Col span={8} key={type.value}>
                            <Card
                                ...
                                style={{
                                    cursor: 'pointer',
                                    borderColor: selectedType === type.value ? '#0F79BC' : '#f0f0f0',
                                    ...
                                    <>
                                        ...
                                        <Form.Item
                                            ...
                                            shouldUpdate={(prev, curr) =>
                                                prev.required !== curr.required || prev.title !== curr.title
                                            }
                                        >
                                            {() =>
    ...
    const handleUpdateFieldCardGroup = useCallback((fieldId, groupKey) => {
        setFormFields(prevFields =>
            prevFields.map(f => (f.id === fieldId ? { ...f, cardGroup: groupKey || null } : f)),
        );
    }, []);
                ...
                setFormSettings(prevSettings => {
                    ...
                    if (key === 'cardGroupSetting') {
                        ...
                        if (index !== undefined && subKey !== undefined) {
                            ...
                            newSettings.cardGroupSetting = newSettings.cardGroupSetting.filter(
                                (_, i) => i !== index,
                            );
                        ...
                        if (index !== undefined && subKey === 'options') {
                            ...
                            if (value === null) {
                                ...
                                newSettings.globalFilters[index].options = newSettings.globalFilters[
                                    index
                                    ].options.filter((_, optIdx) => optIdx !== value.optIndex); // Assuming value.optIndex is passed
                            } else if (
                                typeof value === 'object' &&
                                ...
                                const optionIndex = newSettings.globalFilters[index].options.findIndex(
                                    opt => opt.id === value.id,
                                );
                                if (optionIndex > -1) {
                            ...
                            children: (
                                <>
                                    <Paragraph type="secondary">
                                        Define groups of fields to be displayed within separate cards in the
                                        form. This is useful for organizing complex forms.
                                    </Paragraph>
                                        ...
                                        <Card
                                            ...
                                            extra={
                                                <Button
                                                    icon={<DeleteOutlined />}
                                                    onClick={() =>
                                                        handleSettingsChange('cardGroupSetting', null, index)
                                                    }
                                                    danger
                                                    type="text"
                                        ...
                                        >
                                            ...
                                            <Form.Item label="Field(s) to Filter">
                                                <Select
                                                    ...
                                                    onChange={value =>
                                                        handleSettingsChange('globalFilters', value, index, 'field')
                                                    }
                                                        ...
                                                        <>
                                                            ...
                                                            {fields.map((optField, optIndex) => (
                                                                <Card
                                                                    key={optField.key}
                                                                    size="small"
                                                                    style={{ marginBottom: 8, background: '#f9f9f9' }}
                                                                                ...
                                                                                <Input
                                                                                    ...
                                                                                    onChange={e =>
                                                                                        handleSettingsChange(
                                                                                            'globalFilters',
                                                                                            {
                                                                                                ...formSettings.globalFilters[index]
                                                                                                    .options[optIndex],
                                                                                                label: e.target.value,
                                                                                                id:
                                                                                                    formSettings.globalFilters[index]
                                                                                                        .options[optIndex]?.id || uuidv4(),
                                                                                            },
                                                                                            index,
                                                                                            'options',
                                                                                            {
